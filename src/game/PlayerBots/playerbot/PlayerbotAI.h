...
public:
    ...
    bool IsSafe(Player* player) { return player && player->GetMapId() == bot->GetMapId() && player->GetInstanceId() == bot->GetInstanceId() && bot->FindMap() && player->FindMap() == bot->FindMap() && !player->IsBeingTeleported(); }
    bool IsSafe(WorldObject* obj) { return obj && obj->GetMapId() == bot->GetMapId() && obj->GetInstanceId() == bot->GetInstanceId() && bot->FindMap() && obj->FindMap() == bot->FindMap() && (!obj->IsPlayer() || !((Player*)obj)->IsBeingTeleported()); }
