...
namespace ai
{
    ...
    public:
        ...
        GameObjectInfo const* GetGameObjectInfo() const { return IsGameObject() ? sObjectMgr.GetGameObjectTemplate(GetEntry()) : nullptr; };
    ...
    public:
        ...
        virtual void setAreaFlag(int16 flag) { areaFlag = flag; areaFlagSet = true; }
        virtual void FetchArea() { areaFlag = WorldPosition::getAreaFlag(); areaFlagSet = true; }
        virtual uint16 getAreaFlag() const override { return areaFlagSet ? areaFlag : WorldPosition::getAreaFlag(); }
    private:
        int16 areaFlag = 0;
        bool areaFlagSet = false;
    };
}
