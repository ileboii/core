...
Item* ItemForSpellValue::Calculate()
{
    ...
    if ((spellInfo->SpellName[0] == "rockbiter weapon") ||
            (spellInfo->SpellName[0] == "flametongue weapon") ||
            (spellInfo->SpellName[0] == "earthliving weapon") ||
            (spellInfo->SpellName[0] == "frostbrand weapon") ||
            (spellInfo->SpellName[0] == "windfury weapon"))
    {
    ...
    if ((spellInfo->SpellName[0] == "disenchant"))
        return NULL;
