...
public:
    ...
    ~PlayerWithoutAuraPredicate() noexcept override = default;
...
public:
    PlayerWithoutMyAuraPredicate(PlayerbotAI* ai, std::string aura) :
        PlayerbotAIAware(ai), FindPlayerPredicate(), auras(split(aura, ',')) {}
    ~PlayerWithoutMyAuraPredicate() noexcept override = default;
...
public:
    TankWithoutAuraPredicate(PlayerbotAI* ai, std::string aura) :
        PlayerbotAIAware(ai), FindPlayerPredicate(), auras(split(aura, ',')) {}
    ~TankWithoutAuraPredicate() noexcept override = default;
