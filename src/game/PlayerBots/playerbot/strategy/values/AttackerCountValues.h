...
namespace ai
{
    ...
    {
    public:
        HasAttackersValue(PlayerbotAI* ai, std::string name = "has attackers") : BoolCalculatedValue(ai, name, 8), Qualified() {}
    ...
    public:
        ...
        virtual uint32 Calculate() override
        {
            ...
            uint32 damage = 0;
            for (auto const& pAttacker : std::set<Unit*>() /* getAttackers not public in vmangos */)
