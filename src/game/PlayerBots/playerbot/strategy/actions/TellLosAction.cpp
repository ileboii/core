...
static const std::string GOS_PARAM = "gos";
static const std::string GAMEOBJECTS_PARAM = "game objects";
static const std::string HIGHLIGHT_PARAM = "highlight";

static const std::string FILTER_NAME_PARAM = "filter:name:";
...
std::vector<LosModifierStruct> TellLosAction::ParseLosModifiers(const std::string& str)
{
   ...
   {
      { auto p1 = param.find_first_not_of(" \t\n\r"); auto p2 = param.find_last_not_of(" \t\n\r"); param = (p1 == std::string::npos) ? "" : param.substr(p1, p2 - p1 + 1); };
