...
namespace ai
{
    ...
    protected:
        virtual WorldPacket GetPacket(Player* player) { WorldPacket data(static_cast<uint16>(opcode), 8); data << player->GetName(); return data; }
    ...
    protected:
        virtual void SendPacket(WorldPacket data, Event event) override { bot->GetSession()->HandleGuildInviteOpcode(MakeTypedPacket<WorldPackets::Guild::GuildInvite>(data)); };
    ...
    protected:
        virtual WorldPacket GetPacket(Player* player) override { WorldPacket data(static_cast<uint16>(opcode), 8); data << bot->GetName(); return data; }
        virtual void SendPacket(WorldPacket data, Event event) override { if(GetPlayer(event)) GetPlayer(event)->GetSession()->HandleGuildInviteOpcode(MakeTypedPacket<WorldPackets::Guild::GuildInvite>(data)); };
    ...
    protected:
        virtual void SendPacket(WorldPacket data, Event event) override { bot->GetSession()->HandleGuildPromoteOpcode(MakeTypedPacket<WorldPackets::Guild::GuildPromote>(data)); };
    ...
    protected:
        virtual void SendPacket(WorldPacket data, Event event) override { bot->GetSession()->HandleGuildDemoteOpcode(MakeTypedPacket<WorldPackets::Guild::GuildDemote>(data)); };
    ...
    protected:
        virtual void SendPacket(WorldPacket data, Event event) override { bot->GetSession()->HandleGuildLeaderOpcode(MakeTypedPacket<WorldPackets::Guild::GuildLeader>(data)); };
        virtual bool PlayerIsValid(Player* member) override { return member->GetGuildId() == bot->GetGuildId() && GetRankId(bot) < GetRankId(member) - 1; };
    };
    ...
    protected:
        virtual void SendPacket(WorldPacket data, Event event) override { bot->GetSession()->HandleGuildRemoveOpcode(MakeTypedPacket<WorldPackets::Guild::GuildRemove>(data)); };
        virtual bool PlayerIsValid(Player* member) override { return member->GetGuildId() == bot->GetGuildId() && GetRankId(bot) < GetRankId(member); };
    };
