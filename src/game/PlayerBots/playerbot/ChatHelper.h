...
namespace ai
{
    ...
    public:
        ...
        static std::string formatSpell(uint32 spellId) {const SpellEntry* const spellInfo = sSpellMgr.GetSpellEntry(spellId); if (!spellInfo) return ""; return formatSpell(spellInfo);};
