...
class ChatHandler
{
    ...
    protected:
        ...
        bool HandleAHBotRebuildCommand(char *);
        bool HandleAHBotStatusCommand(char *);
        bool HandleAHBotItemCommand(char *);
        //Bg
        ...
        */
        ...
        bool HandleNpcSpawnLoadCommand(char* args);
        bool HandleNpcSpawnUnloadCommand(char* args);
